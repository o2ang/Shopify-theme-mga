...
(function () {
  ...
  theme.Variants = (function () {
    function Variants(options) {
      ...
      if (options.variant_selected) {
        this.variant_selected = options.variant_selected;
      }
      ...
      if (this.variant_selected) {
        ...
        document.querySelectorAll(id).forEach((element) => {
          if (element.parentNode.dataset.variant == this.variant_selected) {
            element.setAttribute(
              "id",
              this.container.getAttribute("id") + "-" + this.variant_selected
            );
      ...
      */
      ...
      this.container
        ...
        .forEach((el) => {
          if (options.variant_selected) {
            let input_id =
              el.getAttribute("id") + "-" + options.variant_selected;
            let label_for =
              el.nextElementSibling.getAttribute("for") +
              "-" +
              options.variant_selected;

            el.setAttribute("id", input_id);
            el.nextElementSibling.setAttribute("for", input_id);
          }
    ...
    Variants.prototype = Object.assign({}, Variants.prototype, {
      ...
      _onSelectChange: function ({ srcElement }) {
        ...
        /*
        console.log(
          "_onSelectChange:" + this.container.parentNode.dataset.variant
        );
        */
      },
  ...
  theme.Modals = (function () {
    function Modal(id, name, options) {
      ...
      this.variant = this.modal.dataset.variant;
  ...
  theme.preloadProductModal = function (handle, productId, btn) {
    ...
    if (variant) {
      holder = document.getElementById(
        "QuickShopHolder-" + handle + "-" + variant
      );
    }
    ...
    fetch(url)
      ...
      .then((text) => {
        ...
        if (variant) {
          modalId = "QuickShopModal-" + productId + "-" + variant;
        }

        if (variant) {
          name = "quick-modal-" + productId + "-" + variant;
          holder.setAttribute("data-variant", variant);
        }
        ...
        this.container
          ...
          .forEach((swatch) => {
            swatch.addEventListener("mouseenter", () => {
              ...
              var el = swatch.parentNode.parentNode.querySelector(
                ".grid-product__color-image--" + id
              );
  ...
  theme.HeaderSection = (function () {
    ...
    HeaderSection.prototype = Object.assign({}, HeaderSection.prototype, {
      ...
      initDisclosures: function () {
        ...
        var localeEl_drawer = document
          .querySelector("#NavDrawer")
          .querySelector(selectors.locale);
        var currencyEl_drawer = document
          .querySelector("#NavDrawer")
          .querySelector(selectors.currency);

        if (localeEl_drawer) {
          this.localeDisclosure_drawer = new theme.Disclosure(localeEl_drawer);
        }
        if (currencyEl_drawer) {
          this.currencyDisclosure_drawer = new theme.Disclosure(
            currencyEl_drawer
          );
        }
      },
      ...
      onUnload: function () {
        ...
        if (this.localeDisclosure_drawer) {
          this.localeDisclosure_drawer.destroy();
        }

        if (this.currencyDisclosure_drawer) {
          this.currencyDisclosure_drawer.destroy();
        }
      },
    });
  ...
  theme.Product = (function () {
    ...
    function Product(container) {
      ...
      this.variant = container.parentNode.dataset.variant;
      ...
      if (this.inModal) {
        ...
        if (this.variant) {
          this.modal = document.getElementById(
            "QuickShopModal-" + productId + "-" + this.variant
          );
        }
      }
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      init: function () {
        if (this.inModal) {
          ...
          if (!this.variant) {
            ...
            document.addEventListener(
              "modalOpen.QuickShopModal-" + this.productId + "-" + this.variant,
              this.openModalProduct.bind(this)
            );
            document.addEventListener(
      ...
      initVariants: function () {
        ...
        if (this.variant) {
          options.variant_selected = this.variant;
        }
          ...
          swatches.forEach((swatch) => {
            swatch.addEventListener(
              ...
              function (evt) {
                ...
                //console.log("swatch change:" + color + "," + index);
      ...
      openModalProduct: function () {
        ...
        //  console.log(this.settings.modalInit);
          ...
          fetch(url)
            ...
            .then(
              function (html) {
                ...
                /**/
                variantSet(this.container, this.variant);
              }.bind(this)
            );
        ...
        function variantSet(container, variant) {
          if (variant) {
            //console.log("variantSet:" + variant);
            //console.log(container.parentNode);
            let parentNode = container.parentNode;
            let variantOptions = parentNode.dataset.variantOptions;
            //console.log(variantOptions);
            let arr = variantOptions.split(",");
            setTimeout(function () {
              /*
              let str = 'input[data-variant="' + variant + '"]';
              let input = container.querySelector(str);
              if (input) {
                input.checked = true;
